...
import sys
SV2V = "sv2v"
PROJ_ROOT = "/work/stu/cwang/work/hehecore-2-0"
SRC_DIR = "src"
MODULE_DIR = "rvh_mmu_v"
FILELIST_DIR = f"{PROJ_ROOT}/{SRC_DIR}/{MODULE_DIR}/svflist.f"
NEW_FILELIST_DIR = f"{PROJ_ROOT}/{SRC_DIR}/{MODULE_DIR}/vflist.f"
argv = sys.argv
